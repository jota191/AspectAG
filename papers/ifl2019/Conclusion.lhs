...
examples we have coded during the development, the library will be tested
soon in the implementation of the compiler of a non trivial functional language.
Having the DSL embedded in Haskell allows the developing of furher
abstractions, such as common patterns, or macros.
