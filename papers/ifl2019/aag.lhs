...
\title{Attribute Grammars blah blah}
...
\affiliation{%
  ...
  \city{Montevideo}
  \country{Uruguay}}
\email{larstaffiliation.org}

\author{Marcos Viera}
\affiliation{\institution{Instituto de Computación}}
\email{jsmithaffiliation.org}

\author{Alberto Pardo}
\affiliation{\institution{The Kumquat Consortium}}
\email{jpkumquatconsortium.net}
...
\begin{abstract}
Rem quia necessitatibus ullam sit sunt aperiam. Voluptas ratione suscipit molestiae atque. At repellendus placeat veniam et rerum. Eos amet minus omnis id. Aut officia in delectus quisquam labore earum. Est ipsa et corporis voluptas facere quos. Nesciunt consequatur velit provident in architecto. Et error quos sed. Aut ipsam ullam at. Id soluta eum eius ex quis rerum minus fugiat. Cumque corrupti voluptatibus quia ut aut animi quas. Corporis ducimus error ea ullam nemo delectus. Consequatur minima autem et consequatur quae minus. Veritatis provident voluptatum nihil magnam distinctio quo praesentium aperiam. Ducimus repellat sit incidunt nulla. Architecto voluptate molestias iure tenetur neque. Ex dolore ipsum repellat aut. Inventore tempora modi sit voluptas eum sed molestiae eos. Architecto similique vel laboriosam vel aut qui qui aut. Doloribus et est enim culpa tenetur. Amet facere quia quis aliquid exercitationem suscipit illum qui. 
\end{abstract}
...
and structures available in ; this section will just
